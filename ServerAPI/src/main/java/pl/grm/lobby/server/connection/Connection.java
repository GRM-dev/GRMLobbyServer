...
import pl.grm.lobby.server.gui.ConnectionTab;
import pl.grm.lobby.server.json.JsonConvertException;
	...
	public void run() {
		if (!isConnected() && !isInitialized()) {
			try {
				...
				closeConnection();
				if (isClosing()) {
					CLogger.info("Succesfully dilobbyected client with ID: " + ID);
				} else {
