...
public enum Property {
	DATABASE_HOSTNAME("DB_Host", PropertyType.STRING), DATABASE_PORT("DB_",
			PropertyType.INT, "3306"), DATABASE_USERNAME("DB_Username",
			PropertyType.STRING), DATABASE_PASSWORD("DB_Password",
			PropertyType.STRING);
