...
public class MSGCommand implements ICommand {
	...
	/* (non-Javadoc)
	 * @see pl.grm.sconn.commands.ICommand#execute(pl.grm.sconn.commands.Commands, java.lang.String, pl.grm.sconn.commands.CommandType, pl.grm.sconn.connection.Connection)
	 */
	@Override
